...
if [[ $MISSING_COUNT -gt 0 || $ERROR_COUNT -gt 0 ]]; then
    ...
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "📚 NEXT STEPS: Extract & Categorize Lessons Learned"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "1. Extract lessons from this report:"
    echo "   → bash .specify/scripts/bash/extract-lessons-learned.sh"
    echo ""
    echo "2. Review extracted lessons and duplicate check"
    echo ""
    echo "3. If new lessons exist, manually categorize into:"
    echo "   → .specify/memory/lessons-learned.md"
    echo "   → Categories: Testing & Quality, Technical Architecture, etc."
    echo "   → Add source attribution (Sprint, Phase, Date)"
    echo "   → Add actionable guidance"
    echo ""
    echo "4. Script will auto-update timestamp when complete"
    echo ""
    exit 0
fi
