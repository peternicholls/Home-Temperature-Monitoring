...
## Recent Changes
- 2025-11-22: Improved logging format and added log rotation (ref: #55)
- 2025-11-21: Updated README with development guidelines (ref: #50)
- 2025-11-20: Added venv activation reminder to agent session init script (ref: #45)
